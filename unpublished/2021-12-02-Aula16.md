...
## Apresentação
[BioPerl](/introprog2021/pdf/aula16.pdf)    
...
## Arquivos 
[Genbank_flatfile.txt](/introprog2021/files/Genbank_flatfile.txt)  
[dmel-gene-r5.45.fasta](/introprog2021/files/dmel-gene-r5.45.fasta)       
[BLASToutput.txt](/introprog2021/files/BLASToutput.txt)  
...
## Exercício (não entra na média final, apenas para treinamento)

Crie um script que faça as tarefas muito similares ao script do exercício anterior, mas, desta vez, deverá usar BioPerl.
